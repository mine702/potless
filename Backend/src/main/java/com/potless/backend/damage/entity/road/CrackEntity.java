...
public class CrackEntity extends DamageEntity {
    ...
    public CrackEntity(Long id, Integer severity, Double dirX, Double dirY, String address, Double width, Status status, AreaEntity areaEntity, LocationEntity locationEntity, HexagonEntity hexagonEntity, List<ImageEntity> imageEntities, String dtype, MemberEntity memberEntity) {
