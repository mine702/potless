...
public class CrackEntity extends DamageEntity {
    ...
    @Builder
    public CrackEntity(Long id, Integer severity, Double dirX, Double dirY, String address, String roadName, Status status, Double width, AreaEntity areaEntity, LocationEntity locationEntity, List<ImageEntity> imageEntities) {
